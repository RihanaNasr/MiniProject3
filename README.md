...
│                                                                                 │
│  ┌──────────────┐      ┌──────────────────┐      ┌──────────────────────────┐  │
│  │  ratings.dat │─────▶│   Spark Batch    │─────▶│     ALS Model (saved)    │  │
│  │ (MovieLens   │      │   (Training)     │      │     models/als_model     │  │
│  │   1M)        │      │                  │      └────────────┬─────────────┘  │
│  └──────────────┘      └──────────────────┘                   │                │
│                                                               │                │
│                                                               ▼                │
│  ┌──────────────┐      ┌──────────────────┐      ┌──────────────────────────┐  │
│  │    Kafka     │─────▶│      Kafka       │─────▶│   Spark Structured       │  │
│  │  Producer    │      │     Topic        │      │      Streaming           │  │
│  │ (Python)     │      │ movie-ratings    │      │                          │  │
│  │              │      │ (2 partitions)   │      │  - Window: 30s/10s       │  │
│  │ key=item_id  │      │                  │      │  - Custom metric         │  │
│  └──────────────┘      └──────────────────┘      │  - Alert system          │  │
│                                                   │  - Recommendations       │  │
│                                                   └────────────┬─────────────┘  │
│                                                                │                │
...
│                                         ▼                      ▼                ▼
│                              ┌──────────────────┐  ┌──────────────────┐  ┌─────────────┐
│                              │   Console Output │  │   JSON Files     │  │   Graphs    │
│                              │ - Trending items │  │ - Analytics      │  │  (PNG)      │
